...
char plc_program_md5[] = "5e4ee5242633df39f93586169ca087e7";
...
static const struct {
    ...
    {&(RES0__INSTANCE0.FILL_TIME_TO_COUNT), TIME_ENUM},
    {&(RES0__INSTANCE0.DISCHARGE_TIME_TO_COUNT), TIME_ENUM},
    {&(RES0__INSTANCE0.ONLY_DIS), BOOL_ENUM},
    {&(RES0__INSTANCE0.ONLY_FILL), BOOL_ENUM},
    {&(RES0__INSTANCE0.DISCHARGE), BOOL_P_ENUM},
    {&(RES0__INSTANCE0.I_FILL), BOOL_P_ENUM},
    {&(RES0__INSTANCE0.DISCHARGE_VALVE), BOOL_O_ENUM},
    {&(RES0__INSTANCE0.DISCHARGING), BOOL_O_ENUM},
    {&(RES0__INSTANCE0.FILL_VALVE), BOOL_O_ENUM},
    {&(RES0__INSTANCE0.FILLING), BOOL_O_ENUM},
    {&(RES0__INSTANCE0.TIMER), INT_O_ENUM},
    {&(RES0__INSTANCE0._TMP_TIME_TO_INT8073191_ENO), BOOL_ENUM},
    {&(RES0__INSTANCE0._TMP_TIME_TO_INT8073191_OUT), INT_ENUM},
    {&(RES0__INSTANCE0._TMP_TIME_TO_INT6710441_ENO), BOOL_ENUM},
    {&(RES0__INSTANCE0._TMP_TIME_TO_INT6710441_OUT), INT_ENUM},
};
